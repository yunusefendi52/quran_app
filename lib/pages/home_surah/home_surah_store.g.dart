...
mixin _$HomeSurahStore on _HomeSurahStore, Store {
  final _$chaptersAtom = Atom(name: '_HomeSurahStore.chapters');
  ...
  final _$stateAtom = Atom(name: '_HomeSurahStore.state');
